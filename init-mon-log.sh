...
juju run-action --wait grafana/0 import-dashboard dashboard="$(base64 $scriptPath/grafana-telegraf.json)"
juju run-action --wait grafana/0 import-dashboard dashboard="$(base64 $scriptPath/grafana-k8s.json)"
